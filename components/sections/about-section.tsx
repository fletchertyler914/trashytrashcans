...
const features = [
  {
    ...
    description:
      "These ain't your grandma's trash cans! Unless your grandma is a punk rocker! 🤘",
  },
  {
    icon: <Skull className='h-12 w-12' />,
    title: 'DEATH TO BORING',
    description:
      'Why blend in when you were born to STAND OUT? Make your garbage GLORIOUS!',
  },
  {
    icon: <Bomb className='h-12 w-12' />,
    title: 'REBEL APPROVED',
    description:
      "Each design screams 'I DON'T FOLLOW YOUR RULES!' Perfect for HOA nightmares!",
  },
  {
    icon: <Zap className='h-12 w-12' />,
    title: 'SHOCK VALUE',
    description:
      "Watch Karen's jaw drop when she sees your new statement piece! 😈",
  },
];
