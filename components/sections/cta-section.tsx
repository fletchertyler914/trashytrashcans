...
export function CTASection() {
  return (
    <section className='py-24 bg-black relative overflow-hidden' id='join-now'>
      ...
      <div className='container px-4 mx-auto text-center relative z-10'>
        ...
        >
          JOIN THE TRASH REVOLUTION! 🔥
          <br />
          Get 10% off when we launch + exclusive access to our most INSANE
          designs!
        </p>
